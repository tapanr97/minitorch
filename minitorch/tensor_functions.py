...
def make_tensor_backend(tensor_ops, is_cuda=False):
    ...
    class Backend:
        ...
        class Exp(Function):
            ...
            def backward(ctx, grad_output):
                # TODO: Implement for Task 2.4.
                expo = ctx.saved_values
                return mul_zip(expo, grad_output)
        ...
        class Permute(Function):
            ...
            def forward(ctx, a, order):
                # TODO: Implement for Task 2.3.
                ctx.save_for_backward(a)
                permuted_tensor_data = a._tensor.permute(*order)
                return Tensor.make(permuted_tensor_data._storage,
                                   permuted_tensor_data.shape,
                                   strides=permuted_tensor_data.strides,
                                   backend=a.backend)
